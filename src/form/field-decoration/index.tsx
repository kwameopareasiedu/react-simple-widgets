...
export const FieldDecoration = ({ decoration, stickyLabel, label, leading, trailing, error, disabled, children }: Props) => {
    ...
    const className = (): string => {
        ...
        if (stickyLabel || hasValue) classes.push("has-value");
