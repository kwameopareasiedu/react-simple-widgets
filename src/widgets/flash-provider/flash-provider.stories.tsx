...
export const Default = (): any => {
  const ExampleApp = (): any => {
    const { flashInfo, flashWarning, flashError, flashSuccess } =
    ...
    return (
      <div>
        <button
          ...
          onClick={(): void =>
            flashError("Error", <i>{message}</i>, () => alert("Dismissed"))
          }>
          Flash error
        </button>
        ...
        <button
          ...
          onClick={(): void =>
            flashWarning("Warning", <strong>{message}</strong>, () =>
              alert("Dismissed")
            )
          }>
          Flash warning
        ...
        <button
          ...
          onClick={(): void =>
            flashInfo("Info", <u>{message}</u>, () => alert("Dismissed"))
          }>
          Flash info
        </button>
        ...
        <button
          ...
          onClick={(): void =>
            flashSuccess("Success", message, () => alert("Dismissed"))
          }>
          Flash success
        </button>
