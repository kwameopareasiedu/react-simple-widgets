(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = chunkId =>
      ...
      "." +
      {
        104: "0eef098216f37daa239b",
        295: "4a8973cbb3592b8045be",
        331: "9fc9491a42894f170b43",
        459: "c7f94d6efa2ac68b086d",
        861: "ceb403e1172d4699d6de",
        913: "d1682fc3e9314335f51b"
      }[chunkId] +
      ".manager.bundle.js"),
      ...
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (var scripts = document.getElementsByTagName("script"), i = 0; i < scripts.length; i++) {
            var s = scripts[i];
            if (s.getAttribute("src") == url || s.getAttribute("data-webpack") == "react-simple-widgets:" + key) {
              script = s;
              break;
            }
          }
        script ||
          ...
          script.setAttribute("data-webpack", "react-simple-widgets:" + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkreact_simple_widgets = self.webpackChunkreact_simple_widgets || []);
